...
REGION=eu-west-1
AWS_ACCOUNT_ID=274349858350
PROFILE=default
#PROFILE=personalAccount
DOCKER_APP_NAME=kastrubait-cart-api

DOCKER_APP_REPOSITORY=kastrubait-cart-api
...
# Build Docker image
docker build -f "$(dirname "$0")/../../Dockerfile" -t $DOCKER_APP_REPOSITORY:"$DOCKER_TIME_TAG" -t $DOCKER_APP_REPOSITORY:$DOCKER_LATEST_TAG "$(dirname "$0")/../../"
